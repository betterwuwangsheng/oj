...
//
// import static cn.little.prince.onlinejudgebackendcommon.constant.MqConstant.CODE_DLX_QUEUE;
//
// /**
//  * code MQ 失败
//  *
...
//         if (!update) {
//             log.info("处理死信队列消息失败,对应提交的题目 id 为:{}", questionSubmit.getId());
