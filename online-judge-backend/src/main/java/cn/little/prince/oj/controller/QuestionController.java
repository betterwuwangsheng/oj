...
import cn.little.prince.oj.annotation.AuthCheck;
import cn.little.prince.oj.common.BaseResponse;
import cn.little.prince.oj.common.DeleteRequest;
import cn.little.prince.oj.common.ErrorCode;
import cn.little.prince.oj.exception.BusinessException;
import cn.little.prince.oj.model.dto.question.*;
import cn.little.prince.oj.model.dto.questionsubmit.JudgeInfo;
...
import cn.little.prince.oj.model.vo.JudgeVO;
import cn.little.prince.oj.model.vo.QuestionSubmitVO;
import cn.little.prince.oj.model.vo.QuestionVO;
...
import cn.little.prince.oj.utils.CopyUtils;
...
public class QuestionController {
    ...
    public BaseResponse<Boolean> deleteQuestion(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        ...
        // 仅本人或管理员可以删除
        boolean conditions = !question.getUserId().equals(loginUser.getId()) && !userService.isAdmin(request);
    ...
    public BaseResponse<Question> getQuestionById(long id, HttpServletRequest request) {
        ...
        // 不是本人或管理员，不能直接获取所有信息
        boolean conditions = !question.getUserId().equals(loginUser.getId()) && !userService.isAdmin(loginUser);
