package cn.little.prince.oj.sandbox.utils;
...
public class ProcessUtils {
    ...
    public static ExecuteMessage handleProcessMessage(Process runProcess, String operationName) {
        ...
        return ExecuteMessage.builder().exitValue(exitCode).message(output.toString()).errorMessage(errorOutput.toString()).build();
    }
